...
let CommentSchema = new Schema({
    ...
    PostId: {type: Object, required: true}, // this is the id of the post to bind it to the post so we can display the post title
    Comment: {type: String, required: true, max: 100000}, // the comment itself
